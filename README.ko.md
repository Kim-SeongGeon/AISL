...
- [ ] 실제 SlideGraph 후보 생성부 및 CLIPPER 연결 후 비교 실험
...
| 조건 | B에만 추가한 객체 수 | B의 각 좌표에 적용한 Gaussian 잡음 표준편차 |
|---|---:|---:|
| clean | 0 | 0 m |
| extra_2 | 2 | 0 m |
| extra_5 | 5 | 0 m |
...
- 위치 잡음만으로 후보 수가 바뀌지 않는 이유는 현재 후보 생성이 위치를 사용하지 않고 class만 비교하기 때문임.
...
- 실제 물체의 대응이 맞더라도 위치 잡음 때문에 추정 변환에 오차가 생길 수 있음을 oracle 예제로 확인하였음.
