...
|---|---:|---:|---:|---|---|---|---|
| 0.2 m | 35,913 | 38,287 | 80.22% | 높음 | 궤적 추정은 정상이나 기준 설정과 최종 위치 차이 존재 | 구조가 가장 조밀하고 연속적이나 일부 표면이 두껍게 중첩됨 | 정상 |
| 0.5 m | 4,400 | 5,485 | 81.10% | 중간 | 안정적인 궤적과 구조 정합 유지 | 벽과 기둥 윤곽이 비교적 안정적으로 유지됨 | 정상, 균형이 가장 양호 |
| 1.0 m | 1,432 | 1,751 | 75.40% | 낮음 | 유효점 부족 경고와 함께 정합 안정성 저하 | 세부 구조가 감소하고 국부적 정합 안정성이 저하됨 | `No Effective Points!` 반복 발생 |
